...
import json
from .models import CustomUser, Staffs, Courses, Subjects, Students, SessionYearModel, Attendance, AttendanceReport, FeedBackStaffs, StudentResult
...
def staff_home(request):
	...
	return render(request, "staff_home_template.html", context)
...
def staff_update_attendance(request):
	...
	return render(request, "update_attendance_template.html", context)
...
def staff_add_result(request):
	...
	return render(request, "add_result_template.html", context)
